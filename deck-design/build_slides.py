  ...
  <div style="display:grid; grid-template-columns:repeat(2, minmax(0,1fr)); gap:88px; margin-top:46px;">
    <div>
      ...
      <div class="hair" style="padding:23px 0 20px;">
        ...
        <div class="b" style="margin-top:5px;">Driving Strategy, AI and GTM — building B2B go-to-market engines from
          scratch, from ICP research to outbound to AI search visibility.</div>
      </div>
      ...
      <div style="display:flex; gap:20px; padding:23px 0;">
        ...
        <div>
          ...
          <div class="b" style="margin-top:6px;">As a VC analyst I spent 100+ hours with founders and operators,
            ...
            share-of-voice audit — all shipping as working files.</div>
        </div>
      </div>
    </div>
  </div>
...
S["Agenda"] = page(f"""
  {header("", "The what, why and how",
          "How this deck is structured and — most importantly — what I would drive once I join the team.")}

  <div style="display:grid; grid-template-columns:repeat(2, minmax(0,1fr)); gap:88px; margin-top:46px;">
    <div>
      <div class="sec">How the deck is structured</div>
      <div style="margin-top:6px;">
        {agenda_row("01", "Who buys Lio — the ICP, sourced and counted", "Findings")}
        {agenda_row("02", "Where they gather — the event pipeline, re-verified", "Findings")}
        {agenda_row("03", "What the market hears — LinkedIn share of voice", "Findings")}
        {agenda_row("04", "What I would own from day 0", "Strategy", "chip chip-dark")}
        {agenda_row("05", "Why hire me — what you get in return", "The offer", "chip chip-dark")}
      ...
      <div class="panel" style="margin-top:34px;">
        ...
        <ol style="margin:12px 0 0; padding-left:19px; font-size:15px; line-height:1.55; color:#2E2E28;">
          <li><b>The ICP is countable:</b> 219 named buyers of 2,245 identified across 4 segments — outbound can start
            on day 0.</li>
          <li><b>The trigger is not the one we assumed:</b> one true third-party BPO in 35 swept accounts. In DACH the
            target is the captive SSC, and the trigger is a change event.</li>
          <li><b>The event plan is live now:</b> the late-September gauntlet starts in two weeks; every date
            re-verified against organiser sources.</li>
          <li><b>Share of voice is founder-heavy and customer-silent</b> — an ops gap, not a budget gap.</li>
    ...
    <div>
      ...
      <div style="margin-top:20px;">
        ...
        <div class="b" style="margin-top:9px;">3. <b>Give Keil and Wagner leverage:</b> prep, notes, pipeline hygiene
          and the analysis layer of the $10M Challenge — founders&#39; hours back, every week.</div>
      </div>
      <div style="border-top:1px solid {HAIR}; margin-top:24px; padding-top:20px;">
        <div class="rowh">Long term</div>
        <div class="b" style="margin-top:10px;">1. <b>Own a slice of the US field engine</b> as the NYC pod scales —
          the field-marketing layer the Q2-27 calendar already requires.</div>
...
S["IcpFindings"] = page(f"""
  {header("<em>01</em> · Findings — sourced from Apollo against Lio&#39;s reverse-engineered ICP",
          "The market is countable — but the trigger is not the one the plan assumed",
  ...
  {icp_row("DACH industrial backbone",
           ...
           "<b>Trust-first, German, in person — timed to a change event.</b> The DACH trigger is the captive SSC/GBS, "
...
S["EventFindings"] = page(f"""
  ...
  <div class="panel-grey" style="margin-top:20px;">
    <div class="b"><b>Status check, six weeks after the plan was written:</b> all four gauntlet dates hold. New since
      ...
      flagship Oct 27–28, <b>colliding with SIG Chicago (Oct 25–28)</b> — split now settled, with Oct 25–26 scheduling
      made a condition of the SIG booking. APC 2027 moved <b>Miami &rarr; New Orleans</b>. NAPES&#39; reported Denver
      move is <b>unverified</b> — hold the &euro;35K. Two early-birds close <b>Sep 30</b>: BME-Symposium (&euro;100)
  ...
  <div style="display:flex; align-items:center; gap:34px; margin-top:18px;">
    ...
    <div class="b" style="border-left:3px solid {INK}; padding-left:26px;">
      ...
      10 sidecar dinners (&euro;120K of it — the highest-ROI line, protect it last).</b><br>
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:52px; margin-top:18px; border-top:1px solid {HAIR};
    ...
    <div>
      ...
      <div class="b" style="font-size:14px; margin-top:8px;">The 17 verified customers cluster at <b>&euro;2.8–4.7B
        revenue, 8–30K staff</b> — exactly the German practitioner fairs&#39; demographic, and the cheapest fit per
...
S["VoiceFindings"] = page(f"""
  {header("<em>03</em> · Findings — every publicly indexed LinkedIn post about Lio · 8 search angles · 31 August 2026",
          ...
          "60 indexed posts: Keil authors 40% of them, customers author none. An ops gap, not a budget gap.")}
  ...
  <div style="display:grid; grid-template-columns:1.08fr 0.92fr; gap:72px; margin-top:30px;">
    <div>
      ...
      <div class="s" style="font-size:12.5px; margin-top:12px;">Found via search-engine indexing of linkedin.com — a
        floor, not a census: the login wall hides an unknown share of posts. Direction is what matters.</div>
    </div>
    ...
    <div style="display:flex; flex-direction:column; gap:14px;">
      <div class="panel-grey">
        ...
        <div class="b" style="font-size:14px; margin-top:7px;">Keil authors 24 of 60 indexed posts; the founder team
          together, 31. A single point of failure — and the cheapest amplifier available: founder-content ops (drafts,
          recaps, clips) multiplies an asset that already works.</div>
      </div>
      <div class="panel-grey">
  ...
  <div style="display:flex; align-items:center; gap:34px; margin-top:26px; background:{SAGE}; padding:22px 30px;">
    ...
    <div class="b" style="color:#2E2E28;"><b>Share of voice is founder-heavy and customer-silent — an ops gap, not a
      budget gap. The events &rarr; content &rarr; advocacy loop I would run closes it.</b> Full register with URLs,
...
S["WhyMe"] = page(f"""
  {header("<em>05</em> · The offer", "Why hire me — what you get in return",
  ...
  <div style="display:grid; grid-template-columns:1.15fr 0.85fr; gap:80px; margin-top:48px;">
    <div>
      ...
      {why("02", "The outbound cold-start problem, already solved.",
           "219 named, titled, LinkedIn-linked buyers — 193 with verified work emails — across four ICP segments with "
           "an approach playbook. <b>The AEs and SDRs start warm</b>, and the list machine keeps refilling it.")}
  ...
  <div style="display:grid; grid-template-columns:1.15fr 0.85fr; gap:80px; margin-top:46px;">
    <div>
      ...
      {scen("&euro;0–175K", "Kill · rotate", "chip chip-line", "The funnel fails its own gate.",
            "0–1 contracts. Assessment&rarr;POC under 10%, POC&rarr;contract under 20% — <b>file 17&#39;s own kill "
      ...
      <div style="margin-top:20px; border-top:1px solid {HAIR}; padding-top:16px;">
        <div class="lbl" style="color:{INK}; margin-bottom:12px;">What moves these numbers — the three load-bearing
          assumptions</div>
  ...
  <div style="display:grid; grid-template-columns:repeat(2, minmax(0,1fr)); gap:88px; margin-top:44px;">
    <div>
      ...
      {filerow("Spreadsheet", "16-event-status-update.md + Lio_P1_Event_Status_2026-08-31.csv",
               "60 scored events across US/UK/EU-DACH, P1/P2/P3 tiers — every P1 date, venue and deadline re-verified "
