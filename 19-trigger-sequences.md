# 19 · Trigger-Group Sequences — Built in lemlist (DRAFT, not launched)
...
| Account | Target from [scorecard](Lio_H1_Test_Scorecard.csv) | Email status | Resolution |
|---|---|---|---|
...
| Campaign (lemlist ID) | Language | Steps | Leads |
|---|---|---|---|
...
**Regel aus [18](18-trigger-group-outreach-angles.md):** keine Kosten-/Stellenabbau-Argumente im Erstkontakt (Betriebsrats-Sensibilität).
...
### Innomotics (DE)
**Step 1 — Betreff: "Backoffice neu aufbauen — ohne Shared Service Center"** — die vierte Option (kein Hiring, kein SSC, kein BPO): agentisch, <2 Wochen, rein Opex, nichts abzulösen.
**Step 2 (+5d):** CFO-Winkel — Strukturvermeidung statt Einsparung, 6-Monats-ROI-Referenz.
**Step 3 (+7d):** Abschluss — "wenn der Backoffice-Aufbau in die konkrete Planungsphase geht."

### LEONI (DE, 2 Touches max)
